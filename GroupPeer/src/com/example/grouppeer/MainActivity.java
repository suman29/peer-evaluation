...
public class MainActivity extends Activity {
	...
	DatagramSocket sock;
	private String performance,files,assignment,changepwd,question;
    ...
    @Override
      public void onCreate(Bundle savedInstanceState) {
          ...
          performance = this.getString(R.string.performance);
          files= this.getString(R.string.files);
          assignment = this.getString(R.string.assignment);
          changepwd = this.getString(R.string.changepwd);
          question = this.getString(R.string.question);
