...
public class True_false extends Activity  implements OnClickListener 
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        s1 = this.getString(R.string.ques_accepted_by_teacher);
        s2 = this.getString(R.string.ques_rejected_by_teacher);
			...
			while( true )
			{
				...
				if( recvpack.seq_no == PacketSequenceNos.QUIZ_QUESTION_PACKET_SERVER_ACK && recvpack.quizPacket == true )
				{
					...
					if( qpack.questionAuthenticated == true )
					{
						 ...
						 */
						Toast t1 = Toast.makeText(this, s1, 2000);
						t1.show();
					...
					else
					{
						...
						Toast t1 = Toast.makeText(this, s2, 2000);
						t1.show();
