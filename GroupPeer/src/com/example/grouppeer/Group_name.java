...
public class Group_name extends Activity implements View.OnClickListener
{
	...
	DatagramSocket sock;
	TextView error;
	private String tryagain,unknown_error;
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        tryagain = this.getString(R.string.please_try_again);
        unknown_error = this.getString(R.string.unknown_error1);
