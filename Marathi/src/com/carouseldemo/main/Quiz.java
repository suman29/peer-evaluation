	...
	{   
		...
		if( pyy.leader_req_packet == true )
		{
			...
			if( lpp.granted == true )
			{
				...
				leader.setText("आपण आता नेते आहेत!"); //You are Leader now!
			}
			else
			{
				leader.setEnabled(false);
				errorMsg.setText("आपण एक नेता म्हणून निवडले गेले नाहीत. पुढील वेळी प्रयत्न करा.");   //You have not been selected as a leader :D , Better luck next time :P
...
//		startActivity(i);	
	...
	public void setInstructions()
	{
		...
		instruction1.setText("--->"+QuizAttributes.noOfOnlineStudents+"विद्यार्थ्यांना ऑनलाइन आहेत");
		instruction2.setText("--->उत्सुक सत्र"+QuizAttributes.noOfRounds+"फेर्यांमध्ये समावेश");
		instruction3.setText("--->या सत्राचा विषय"+QuizAttributes.subject+" आहे");
		instruction4.setText("--->तेथे"+QuizAttributes.noOfLeaders+"नेत्यांनी असतील आणि प्रत्येक गट"+QuizAttributes.sizeOfGroup+"सदस्यांची होईल");
