	...
	public void onClick(View v) 
	{
		 ...
		 if( recvd_pack.auth_packet == true )
		 {
	    	  ...
	    	  else
	    	  {
	    		  	...
	    		  	{
	    		  		errorText.setText("आपण आधीच मध्ये लॉग इन आहात"); //You are already logged in
	    		  	}
	    		  	else if( auth_pack.errorCode == Utilities.INVALID_FIELDS )
	    		  	{
	    		  		errorText.setText("प्रविष्ट फील्ड अवैध आहेत");//The entered fields are invalid
	    		  	}
	    		  	else if( auth_pack.errorCode == Utilities.INVALID_USER_PASS )
	    		  	{
	    		  		errorText.setText("आपले वापरकर्तानाव आणि संकेतशब्द तपासा");//Please check your username and password
	    		  	}
	    	  }
	      ...
	      {
	    	  errorText.setVisibility(View.VISIBLE);
	    	  errorText.setText("अवैध विनंती स्वरूप "); //Invalid request format 
	      }
	}
