        ...
        public void onItemClick(CarouselAdapter<?> parent, View view,int position, long id) {	
			...
			public void onItemSelected(CarouselAdapter<?> parent, View view,
				...
				case 0:
					...
					txt.setText("कार्यक्षमता"); //performance
					
					break;
				case 1:
					txt.setTypeface(null, Typeface.BOLD|Typeface.ITALIC);
					txt.setText("नेमून दिलेली कामगिरी");   //assignments
					break;
				case 2:
					txt.setTypeface(null, Typeface.BOLD|Typeface.ITALIC);
					txt.setText("फाइल्स");  //files
					break;
				case 3:
					txt.setTypeface(null, Typeface.BOLD|Typeface.ITALIC);
					txt.setText("प्रश्न");  //questions
					break;
				case 4:
					txt.setTypeface(null, Typeface.BOLD|Typeface.ITALIC);
					txt.setText("पासवर्ड बदलू"); //change password
					break;
				}
